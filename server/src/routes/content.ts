...
const DEFAULT_CONTENT: Array<{ section: string; field: string; value: string }> = [
    ...
    { section: 'about_page', field: 'philosophy_title', value: 'Filosofi' },
    ...
    { section: 'about_page', field: 'btl_closing_text', value: 'Setiap momen yang tertangkap adalah cerita yang terpelihara seumur hidup.' },
